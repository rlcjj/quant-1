...
class RiskFactorBarraNolinearSize(RiskFactor):

    """
    因子说明
    Barra Risk Model USE4 中 市值因子的立方和市值因子回归取残差 再去极值和标准化
    在这里 市值因子的平方的负值 和市值因子回归取残差 再去极值和标准化，这样计算出的因子收益和Barra才类似
    """
    ...
    def __init__(self):
        ...
        self.factor_name = 'cne5_normal_non_linear_size'
...
if __name__ == "__main__":
    ...
    self = RiskFactorBarraNolinearSize()
    # self.update_data()
