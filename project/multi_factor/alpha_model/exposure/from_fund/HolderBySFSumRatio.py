...
def HolderBySFSumRatio(beg_date, end_date):

    """
    因子说明：被主动股票基金季报持有在前十大重仓的比例之和
    ...
    ###########################################################################################
    offset_num = 16
    factor_name = "HolderBySFSumRatio"
    ...
    for i_fund in range(0, len(fund_pool)):
        ...
        if fund_holding is not None:
            ...
            stock_mv = stock_mv.add(fund_holding, fill_value=0.0)
...
if __name__ == '__main__':
    ...
    data = HolderBySFSumRatio(beg_date, end_date)
