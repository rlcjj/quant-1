...
def HolderBySFNumberFill(beg_date, end_date):

    """
    因子说明：被主动股票基金季报持有在前十大重仓的基金数量 没有被持有的话填充0
    ...
    ###########################################################################################
    offset_num = 16
    factor_name = "HolderBySFNumberFill"
...
if __name__ == '__main__':
    ...
    data = HolderBySFNumberFill(beg_date, end_date)
    print(data)
