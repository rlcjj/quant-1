...
def HolderBySFIf(beg_date, end_date):

    """
    因子说明：是否被主动股票基金季报持有在前十大重仓
    ...
    holdernumber[holdernumber.applymap(lambda x: x > 0.0)] = 1.0
    ...
    csv_file = r'C:\Users\doufucheng\OneDrive\Desktop\HolderBySFIf.csv'
...
if __name__ == '__main__':
    ...
    data = HolderBySFIf(beg_date, end_date)
