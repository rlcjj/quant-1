...
class HoldingQuarter(Data):
    ...
    def cal_all_wind_file(self):
        ...
        for i_date in range(len(date_series)):
            ...
            number = min(300, len(stock_data_weight))
            stock_data_weight = stock_data_weight.iloc[0:number, :]
            stock_data_weight /= stock_data_weight.sum()
...
if __name__ == '__main__':
    ...
    WindPortUpLoad().upload_weight_period("公募股票基金季报Sample")
