...
class HoldingQuarter(Data):
    ...
    def get_data(self):
        ...
        """ 年报、半年报 普通股票型基金股票权重 作为指数股票权重参考标准 """
    ...
    def cal_weight_date(self, quarter_date):
        ...
        """ 单个年报、半年报普 通股票型基金平均权重 每个基金的权都为1 """
    ...
    def cal_all_wind_file(self):
        ...
        date_series = Date().get_normal_date_series("20040101", datetime.today(), "S")
