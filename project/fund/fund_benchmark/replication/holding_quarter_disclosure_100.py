...
class HoldingQuarter(Data):
    ...
    def cal_all_wind_file(self):
        ...
        for i_date in range(len(date_series)):
            ...
            stock_data_weight = stock_data_weight.sort("Weight", ascending=False)
            stock_data_weight = stock_data_weight.iloc[0:min(100, len(stock_data_weight)), :]
