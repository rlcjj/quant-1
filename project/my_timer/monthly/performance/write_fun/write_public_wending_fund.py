...
def write_public_wending(end_date, save_path):
    ...
    setup_date = '20151223'  # 庄腾飞开始管理
    setup_date2 = '20170616'  # 冀楠开始管理
    ...
    date_array = np.array([["2019年", '20190101', end_date, '20180930'],
                           ...
                           ["庄腾飞管理期间", setup_date, setup_date2, setup_date],
                           ["冀楠管理以来", setup_date2, end_date, setup_date2],
