...
def write_public_yjqd(end_date, save_path):
    ...
    date_array = np.array([["2019年", '20190101', end_date, '20180930'],
                           ...
                           ["成立(20170906)至2017年末", setup_date, '20171231', setup_date],
                           ["成立(20170906)以来", setup_date, end_date, setup_date]
                           ])
    ...
    rank0 = FundRank().rank_fund_array2(fund_pct, bench_pct, fund_code, date_array, "沪深300基金", excess=False)
    rank1 = FundRank().rank_fund_array2(fund_pct, bench_pct, fund_code, date_array, "普通股票型基金", excess=False)
